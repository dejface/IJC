...
/* 																   */
/* Header file, ktory nam bol poskytnuty, obsahuje predpisy funkcii*/
/*******************************************************************/
...
typedef struct htab_iterator {
    ...
    unsigned int idx;            // ve kterém seznamu tabulky
...
inline bool htab_iterator_equal(htab_iterator_t it1, htab_iterator_t it2) {
  return it1.ptr==it2.ptr && it1.t == it2.t ? true : false;
}
const char * htab_iterator_get_key(htab_iterator_t it);
int htab_iterator_get_value(htab_iterator_t it, const char *key);
